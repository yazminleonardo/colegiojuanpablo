<?php
    ...
    $arsenne = mysqli_query( $conexion,"SELECT id_inteligencia FROM  alumnos WHERE Id_alumno = '$usuario'")  ;
    $orpehus=mysqli_fetch_assoc($arsenne);
    $xyz=$orpehus['id_inteligencia']
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="index_alumno.php" class="list-group-item list-group-item-action second-text fw-bold">
                ...
                <?php if($xyz==0){?>
                <a href="tests.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="bi bi-clipboard2-check"></i> Tests
                </a>
                <?php
                }
                ?>
