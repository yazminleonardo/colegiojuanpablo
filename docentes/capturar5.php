...
<div class="container">
    ...
    $alumnos2 = "SELECT * FROM alumnos WHERE grado IN ($grado5) AND nivel = '$nivel_filtrado' AND grupo = '$grupo_filtrado'";
    ...
    $teku = mysqli_query($conexion, "SELECT alumnos.Id_alumno, Nombre, grado, nivel, grupo, Id_asignatura, Id_periodo 
                                     ...
                                     WHERE grado = $grado5 AND id_asignatura = $id_campo AND id_periodo = $numero 
    ...
    $alumnos = mysqli_query($conexion, "SELECT Id_alumno FROM alumnos WHERE grado = $grado5 AND nivel = '$nivel_filtrado' AND grupo = '$grupo_filtrado'");
    ...
    if (isset($_POST['calificar'])) {
        ...
        <script>
            ...
            window.location.href = "tcapturar5.php";
        </script>
    <?php
    }
    ?>
