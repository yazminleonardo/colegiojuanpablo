...
class ReporteCalificaciones extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 6, codificarUTF8('REPORTE DE CALIFICACIONES - GRADO 6 (GRUPO A)'), 0, 1, 'C');
    ...
    function Contenido()
    {
        ...
        // Consulta SQL para obtener las calificaciones del grado 6 y grupo A
        ...
        if ($resultado->num_rows === 0) {
            $this->Cell(0, 10, "No se encontraron calificaciones para el grado 6 (Grupo A) en el trimestre seleccionado.", 0, 1, 'C');
            return;
        }
...
$reporte->Output('reporte_calificaciones_grado6_grupoA.pdf', 'I');
?>