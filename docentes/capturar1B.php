...
$grupo_filtrado = isset($_GET['grupo']) ? $_GET['grupo'] : 'B'; // Valor por defecto 'A'
?>
...
<div class="container">
    ...
    $teku = mysqli_query($conexion, "SELECT alumnos.Id_alumno, Nombre, grado, nivel, grupo, Id_asignatura, Id_periodo 
                                     ...
                                     WHERE grado = $grado1 AND id_asignatura = $id_campo AND id_periodo = $numero 
    ...
    if (isset($_POST['calificar'])) {
        ...
        <script>
            ...
            window.location.href = "tcapturar1B.php";
        </script>
    <?php
    }
    ?>
