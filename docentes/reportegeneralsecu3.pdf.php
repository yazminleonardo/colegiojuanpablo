...
class ReporteCalificaciones extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 6, codificarUTF8('REPORTE DE CALIFICACIONES - GRADO 3'), 0, 1, 'C');
        $this->Ln(12);
    }
    ...
    function Contenido()
    {
        ...
        // Consulta SQL para obtener las calificaciones del grado 3 desde la tabla secu
...
$reporte->Output('reporte_calificaciones_grado3.pdf', 'I');
?>