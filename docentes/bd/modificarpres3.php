...
$id_calificacion = isset($_POST['id_calificaciones']) ? $_POST['id_calificaciones'] : 0; // Asignamos 0 si no existe
...
$stmt = $conexion->prepare("INSERT INTO modificarpres VALUES (NULL, ?, ?, 'Espera', ?, ?, ?, ?)");
...
if ($stmt->execute()) {
    echo "<script>
        ...
        window.location.href = '../modificar_calificacionespres3.php';
    </script>";
} else {
    echo "<script>
