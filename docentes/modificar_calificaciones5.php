...
if (isset($_POST['solicitud'])) {
    ...
    $vista->bind_param("isii", $asignatura, $matricula, $grado5, $periodo);
    $vista->execute();
    $resultados = $vista->get_result();
?>
<br>
<label class="form-label fw-bold">Trimestre: <?php echo "$periodo" ?>° Trimestre</label><br>
<label class="form-label fw-bold">Grado: <?php echo "$grado5" ?>°</label><br>
<label class="form-label fw-bold">Grupo: A</label>
<br>
<form action="bd/solicitud5.php" method="POST">
