...
if (isset($_POST['solicitud'])) {
    ...
    $vista->bind_param("isii", $asignatura, $matricula, $grado4, $periodo);
    $vista->execute();
    $resultados = $vista->get_result();
?>
<br>
<label class="form-label fw-bold">Trimestre: <?php echo "$periodo" ?>° Trimestre</label><br>
<label class="form-label fw-bold">Grado: <?php echo "$grado4" ?>°</label><br>
<label class="form-label fw-bold">Grupo: A</label>
<br>
<form action="bd/solicitud4.php" method="POST">
