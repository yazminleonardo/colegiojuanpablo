...
class ReporteCalificaciones extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 6, codificarUTF8('REPORTE DE CALIFICACIONES - GRADO 1'), 0, 1, 'C');
        $this->Ln(12);
    }
    ...
    function Contenido()
    {
        ...
        // Consulta SQL para obtener las calificaciones del grado 1 desde la tabla secu
        ...
        if ($resultado->num_rows === 0) {
            $this->Cell(0, 10, "No se encontraron calificaciones para el grado 1 en el trimestre seleccionado.", 0, 1, 'C');
            return;
        }
...
$reporte->Output('reporte_calificaciones_grado1.pdf', 'I');
?>