...
class ReporteCalificaciones extends FPDF
{
    ...
    function Contenido()
    {
        ...
        // Consulta SQL para obtener las calificaciones del grado 1 y grupo B usando la tabla prescolar
        $stmt = $conexion->prepare("SELECT alumnos.Matricula, alumnos.Nombre, alumnos.Apellidop, alumnos.Apellidom,
                                    ...
                                    WHERE alumnos.grado = 1 AND prescolar.id_periodo = ? AND alumnos.grupo = 'M'
