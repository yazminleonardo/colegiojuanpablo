...
<div id="subircalif" style="overflow-x: auto;">
    <table class="table table-bordered">
        ...
        <tbody class="table-group-divider">
            ...
            $campos = [
                23 => 'Lenguajes',
                24 => 'Saberes y Pensamiento Cientifico',
                25 => 'Ética, Naturaleza y Sociedades',
                26 => 'De lo humano y lo Comunitario',
                27 => 'Ingles',
                28 => 'Habilidades Digitales',
                29 => 'Edu. Física',
                31 => 'Estimulación Musical Temprana',
                30 => 'Edu. en la Fe',
            ];
            ...
            <tr>
                ...
                <td>
                    <a href="capturarpres2-5.php?id_periodo=<?php echo $periodo_id; ?>&campo=<?php echo $id; ?>&campo_formativo=<?php echo urlencode($nombre); ?>" 
