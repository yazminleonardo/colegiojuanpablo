...
class ReporteGrado2 extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 6, codificarUTF8('REPORTE DE EVALUACIONES - GRADO 2'), 0, 1, 'C');
        $this->Ln(12);
    }
...
// Crear el PDF
$reporte = new ReporteGrado2('L');
$reporte->AddPage();
$reporte->Contenido();
ob_clean(); // Limpia cualquier salida previa
$reporte->Output('reporte_grado2_general.pdf', 'I');
?>