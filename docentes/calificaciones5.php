<?php include_once "vistas/sidebar.php"; ?>
            <h4>Gestor de calificaciones 5° primaria</h4>
            <br>
            <div class="container">
                <div class="row g-4">
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow-sm">
                        <a href="tcapturar5.php" style="background-color: transparent; border: none; text-decoration: none; color:black;" onclick="subircalif()">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow-sm">
                        <a href="ver_calificaciones5.php" style="background-color: transparent; border: none; text-decoration: none; color:black;" onclick="consultarcalif()">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-right">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow-sm">
                        <a href="modificar_calificaciones5.php" style="background-color: transparent; border: none; text-decoration: none; color:black;" onclick="consultarcalif()">
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex">
                                        <div class="media-body text-right">
