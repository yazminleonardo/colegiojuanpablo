...
<h4>Gestor de calificaciones 3° preescolar</h4>
<br>
    <div class="row g-4">
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card shadow-sm">
                <a href="capturapres3.php" class="text-decoration-none text-dark">
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card shadow-sm">
                <a href="vercalificaciones_pres3.php" class="text-decoration-none text-dark">
                    <div class="card-content">
                        <div class="card-body">
        ...
        <!--<div class="col-xl-3 col-sm-6 col-12">
            <div class="card shadow-sm">
                <a href="modificar_calificacionespres3.php" class="text-decoration-none text-dark">
                    <div class="card-content">
                        <div class="card-body">
