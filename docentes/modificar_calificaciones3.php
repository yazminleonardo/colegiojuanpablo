...
<form method="post" class="d-flex row g-3">
    ...
    <div class="col-md-3">
        ...
        <select name="asignatura" id="" class="form-select">
            ...
            $filtro_asignaturas = "id_asignatura IN (12, 13, 14, 15, 38, 16, 17, 39, 19, 20, 21, 22)"; // Cambia esto según tus necesidades
...
if (isset($_POST['solicitud'])) {
    ...
    $vista->bind_param("isii", $asignatura, $matricula, $grado3, $periodo);
    $vista->execute();
    $resultados = $vista->get_result();
?>
<br>
<label class="form-label fw-bold">Trimestre: <?php echo "$periodo" ?>° Trimestre</label><br>
<label class="form-label fw-bold">Grado: <?php echo "$grado3" ?>°</label><br>
<label class="form-label fw-bold">Grupo: A</label>
<br>
<form action="bd/solicitud3.php" method="POST">
