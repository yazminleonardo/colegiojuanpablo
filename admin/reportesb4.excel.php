...
if (isset($_POST['periodo'])) {
    ...
    $sheet->setCellValue("A1", "COLEGIO JUAN PABLO II    1°B    PRIMARIA");
        ...
        if ($row['Matricula'] != $alumno_actual) {
            ...
            for ($i = 0; $i < $totalMaterias; $i++) {
                ...
                if ($i == 2) {
                    ...
                    $promedio3 = ($totalMaterias >= 11) ? ( ($valores[7] + $valores[8] + $valores[9] + $valores[10]) / 4 ) : null;
                    $sheet->setCellValue($col . $fila, number_format($promedio3, 2));
                    $col++;
                }
            }
    ...
    $sheet->getStyle('C3:Q3')->getAlignment()->setTextRotation(90);
    $sheet->getStyle('C3:Q3')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
    $sheet->getStyle('C3:Q3')->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);
    $sheet->getStyle('C:Q')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
    $sheet->getStyle('C:Q')->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);
    ...
    $rangoTabla = "A1:Q" . ($fila - 1); // Rango de la tabla
    $styleArray = [
        'borders' => [
            'allBorders' => [
